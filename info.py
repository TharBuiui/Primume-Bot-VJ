...
API_ID = int(environ.get('API_ID', '27842043'))
API_HASH = environ.get('API_HASH', '6064e22218f51d678d4545025a25c0f9')
BOT_TOKEN = environ.get('BOT_TOKEN', "")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://graph.org/file/1f872af560c122cea5676.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/b69af2db776e4e85d21ec.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/HowTo0penLink")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002020186951'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5976189850 5613239434').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002095162030').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://moviehouse20:moviehouse20@cluster0.ff6ocrj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+fFmB_6zNOfIzMTdl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MovieHouseChannelbot')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/HowTo0penLink')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+fFmB_6zNOfIzMTdl') # Support Chat Link Without https:// or @
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/HowTo0penLink')

# Shortlink Info
SHORTLINK_MODE = bool(environ.get('SHORTLINK_MODE', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'api.shareus.io')
SHORTLINK_API = environ.get('SHORTLINK_API', 'vk0Bf9znIMYfXUwi2JjSO0GMESh2')
